---
title: "STT2860 Introduction to Data Management<br>& Visualization&mdash;Syllabus for Spring 2023"
...
* Wednesday: 11:00am to 12:30pm and 4:40pm to 6:00pm
...
Elective depth assignments will allow you to choose one of several possible "tracks" (3 courses/track) to explore one topic of interest in greater detail. They will be self-paced and due near the end of the semester. You will choose one track and complete all three listed courses. Grading will be credit (1)/no credit (0) for each course. You will receive credit for a course if you earn 80% or more XP for that course.
