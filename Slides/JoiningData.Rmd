...
[Mutating joins](https://dplyr.tidyverse.org/reference/mutate-joins.html) *combine* variables from two data frames / tibbles. Since they **add** variables, they act like a `mutate()` statement. In all cases you get all columns in both sets.
...
[Filtering joins](https://dplyr.tidyverse.org/reference/filter-joins.html) keep cases from the left-hand data frame / tibble based information in the right-hand dataset. Thus, the join acts like `filter()` on the left-hand dataset. 
