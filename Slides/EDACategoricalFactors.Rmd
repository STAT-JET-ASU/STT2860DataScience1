...
The `tidyverse` lets us change multiple variables at once.
...
glimpse(students$Year2)   # glimpse just one variable using $
```
...
glimpse(students$CodedMajor2)   # glimpse just one variable using $
```
