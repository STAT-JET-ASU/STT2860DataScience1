...
Delete this slide from your presentation before using!

1) Update the Packages Used slide to show any packages you used to create your plots. 
2) Describe where you got the dataset you used and define all the variables in the dataset.
3) Tell us about any data manipulation you needed to perform on the dataset before making your plots.
4) Create TWO different types of plots from your dataset. Feel free to experiment a bit! (*There are five example plots; you do not have to do that many.*)

A new slide begins with `##`. You can use a title or leave it blank (as you can see on the plot slides).
...
This dataset did not require any additional manipulation for me to be able to use it. However, if I were to do this again, it might be interesting to join it to a dataset with state population to look at number of prisoners or executions as function of population.

*Note: Describe any variables you created or reformatted, any joining or pivoting you needed to do, etc.*
