# Source: https://github.com/tidyverse/dplyr/blob/main/data-raw/storms.R
...
storm_file_complete <- read_file("https://www.nhc.noaa.gov/data/hurdat/hurdat2-1851-2022-040723.txt")
...
# drop all rows that are not at least a tropical depression
